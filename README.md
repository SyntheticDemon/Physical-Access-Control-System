...
In the design of door , there is a LED light and monitor in front of the door , there we showed the result of authentication using the LED light. (grren light for the authenticated users and red light for unathenticated users.) .We used _Arduino board for controling modules and _ESP8266 _wifi for handling the network part of the project .
